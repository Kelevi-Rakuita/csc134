...
cout << "Die 1: " << roll1 << endl;
cout << "Die 2: " << roll2 << endl;
cout << "ROLL: " << sum << endl;
...
if ((sum == 7) || (sum == 11)) {
    ...
    // NOTE: Don't set point here - game is over!
    }
    else {
    // set the point
    point = sum;
    ...
    cout << "Now you need to roll " << point << " again before rolling a 7!" << endl;
    }
